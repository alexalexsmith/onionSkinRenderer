...
import onionSkinRenderer.constants as constants
...
# Commenting out this because I can never make this work properly
"""
...
def show(develop = False, dockable = False):
    ...
    return OSR_WINDOW.show(dockable = False)
    #return OSR_WINDOW
"""
...
class OSRController(MayaQWidgetDockableMixin, QtWidgets.QMainWindow, ui_window.Ui_onionSkinRenderer):
    ...
    def saveSettings(self):
        ...
        data['rFutureTint'] = list(self.extractRGBFromStylesheet(self.relative_futureTint_btn.styleSheet()))
        data['rPastTint'] = list(self.extractRGBFromStylesheet(self.relative_pastTint_btn.styleSheet()))
        data['aTint'] = list(self.extractRGBFromStylesheet(self.absolute_tint_btn.styleSheet()))
